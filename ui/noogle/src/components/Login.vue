<template>
  ...
  <div>
    ...
    <div v-if="current_user" class="playeauthor-wrapper">

      <div className="dropdown">
        <div class="button" role="button" tabIndex={0}>
          <img :src="this.avatar" alt="" class="avatar"/>
        </div>
        <div className="dropdown-content -start-56 z-[1] horizontal card card-compact w-64 p-2 shadow bg-nostr text-primary-content"
             tabIndex={0}>
          <div className="card-body">
            ...
            <dialog id="nwcmodal" class="modal">
              <div
                  class="modal-box rounded-3xl inner shadow-lg p-6 flex flex-col items-center transition-all duration-1000 bg-base-600/60  ">
                <h3 class="font-bold text-lg">Connect with Nostr Wallet Connect</h3>
                <br>
                <div class="flex">
                  <img alt="" class="avatar" src="/favicon.ico"/>
                ...
                <div v-if="!this.hasNWC">
                  ...
                  <div class="collapse bg-base-200">
                    ...
                    <div class="collapse-title text-xl font-medium bg-black/30 flex">
                      <img class="w-12 h-12 mask mask-squircle bg-zinc-700" src="/Alby.jpg" alt="Alby"
                  ...
                  <div class="collapse bg-base-200">
                    <input name="my-accordion-1" type="radio"/>
                    <div class="collapse-title text-xl font-medium bg-black/30  flex">
                      <img class="w-12 h-12 mask mask-squircle bg-zinc-700" src="/Mutiny.png" alt="Mutiny"
                           style="width: 46px; height: 46px"/>
                      <div style="margin-left: 30px">
                        <h3> Mutiny Wallet</h3>
                    ...
                    <div class="collapse-content">
                      ...
                      <textarea v-model="this.nwcmutiny" class="nwc-Input" cols="40"
                                name="Text1" placeholder="nostr+walletconnect://..." rows="5" style="width: 400px; margin-left: 10px; margin-top: 10px"
                  ...
                  <div class="collapse bg-base-200">
                      ...
                      <svg class="w-12 h-12 mask mask-squircle" fill="none" height="56" viewBox="0 0 56 56" width="56"
                        ...
                        <defs>
                          <radialGradient id="paint0_radial_1138_8450" cx="0" cy="0" gradientTransform="translate(56 56) rotate(-135) scale(79.196 118.441)"
                                          ...
                                          r="1">
                            <stop offset="0" stop-color="#6951FA"></stop>
                    ...
                    <div class="collapse-content">
                      <textarea v-model="this.nwc" class="nwc-Input" cols="40"
                                name="Text1" placeholder="nostr+walletconnect://..." rows="5" style="width: 400px; margin-left: 10px; margin-top: 10px"
                                type="password"></textarea>
    ...
    <template v-if="!current_user">
      <div className="dropdown">
        <div class="v-Button" role="button" tabIndex={0}>Sign in</div>
        <div className="dropdown-content -start-56 z-[1] horizontal card card-compact w-64 p-2 shadow bg-nostr text-primary-content"
             tabIndex={0}>
          <div className="card-body">
            <h3 className="card-title">Login</h3>
            <p>Use a Browser Nip07 Extension like getalby, nos2x or nsec.app, a nsec or ncryptsec or use Amber on
              Android to sign-in</p>
            ...
            <dialog id="nsecmodal" class="modal">
              <div class="modal-box">
                ...
                <p class="py-4">Login with nsec or ncryptsec. Your keys will be stored in your Browser. This is the
                  least recommended sign-in method</p>
                <input v-model="this.ncryptsec" autofocus class="u-Input" name="user" placeholder="nsec.../ncryptsec..."
                       style="margin-left: 10px" type="search">
                <input v-if="ncryptsec.startsWith('ncryptsec')" v-model="this.pw" autofocus
                       class="u-Input" name="user" placeholder="password..." style="margin-left: 10px" type="password">
...
import {
  ...
  NostrLoginInitializer as launchNostrLoginDialog
} from "nostr-login"
import {hasActiveSubscription, parseandreplacenpubs} from "@/components/helper/Helper.vue"
