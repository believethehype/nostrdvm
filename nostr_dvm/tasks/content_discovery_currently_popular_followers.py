...
from nostr_sdk import (
    ClientBuilder, Event, Filter, Keys, Kind, LogLevel, NostrLmdb, PublicKey, RelayLimits, RelayUrl,
    ReqTarget, SecretKey, SignerAuthenticator, SyncDirection, SyncOptions, Tag, Timestamp,
    init_logger,
)
...
class DicoverContentCurrentlyPopularFollowers(DVMTaskInterface):
    ...
    async def process(self, request_form):
        ...
        cli = ClientBuilder().database(database).authenticator(SignerAuthenticator(keys)).relay_limits(relaylimits).build()
